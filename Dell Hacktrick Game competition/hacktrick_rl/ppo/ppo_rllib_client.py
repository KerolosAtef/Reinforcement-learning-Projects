...
from hacktrick_rl.rllib.rllib import HacktrickMultiAgent, save_trainer, gen_trainer_from_params,load_trainer
...
def run(params):
    ...
    trainer = load_trainer('check_points/col/611/checkpoint-611')
